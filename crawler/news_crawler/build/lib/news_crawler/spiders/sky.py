...
class SkySpider(SitemapSpider):
    name = 'sky'
    allowed_domains = ['sky.com']
    sitemap_urls = ['https://news.sky.com/sitemap/sitemap-news.xml']
    ...
    def parse(self, response):
        ...
        text_nodes = response.css('div.sdc-article-body p ::text').getall()
