...
class TimesOfIndiaSpider(SitemapSpider):
    name = 'timesofindia'
    allowed_domains = ['indiatimes.com']
    sitemap_urls = ['https://timesofindia.indiatimes.com/sitemap/today']
    ...
    def parse(self, response):
        ...
        text_nodes = response.css('div[data-articlebody="1"] p ::text').getall()
