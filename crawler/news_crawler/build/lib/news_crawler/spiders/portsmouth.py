...
class PortsmouthSpider(SitemapSpider):
    name = 'portsmouth'
    allowed_domains = ['portsmouth.co.uk']
    sitemap_urls = ['https://www.portsmouth.co.uk/sitemaps/googlenews']
    custom_settings = {
    ...
    def parse(self, response):
        ...
        text_nodes = response.css('div.article-content p ::text').getall()
