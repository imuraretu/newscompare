...
class VanguardngrSpider(SitemapSpider):
    name = 'vanguardngr'
    allowed_domains = ['vanguardngr.com']
    sitemap_urls = ['https://www.vanguardngr.com/news-sitemap.xml']
    custom_settings = {
    ...
    def parse(self, response):
        ...
        text_nodes = response.css('div.entry-content-inner-wrapper p ::text').getall()
