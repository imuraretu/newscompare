...
class DailyStarSpider(SitemapSpider):
    name = 'dailystar'
    allowed_domains = ['thedailystar.net']
    sitemap_urls = ['https://www.thedailystar.net/googlenews.xml']
    ...
    def parse(self, response):
        ...
        text_nodes = response.css('article.article-section p ::text').getall()
