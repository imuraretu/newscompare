...
class WalesOnlineSpider(SitemapSpider):
    name = 'walesonline'
    allowed_domains = ['walesonline.co.uk']
    sitemap_urls = ['https://www.walesonline.co.uk/map_news.xml']
    custom_settings = {
        "USER_AGENT": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.4758.102 Safari/537.36 Edge/108.0.4758.102",
    }
    def parse(self, response):
        ...
        text_nodes = response.css('div.article-wrapper p ::text').getall()
