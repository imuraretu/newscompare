...
class HeraldsunSpider(SitemapSpider):
    name = 'heraldsun'
    allowed_domains = ['heraldsun.com.au']
    sitemap_urls = ['https://www.heraldsun.com.au/news-sitemap.xml']
    custom_settings = {
    ...
    def parse(self, response):
        ...
        text_nodes = response.css('div#story-primary p ::text').getall()
