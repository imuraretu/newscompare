...
class TheScottishSunSpider(SitemapSpider):
    name = 'thescottishsun'
    allowed_domains = ['thescottishsun.co.uk']
    sitemap_urls = ['https://www.thescottishsun.co.uk/news-sitemap.xml']
    custom_settings = {
    ...
    def parse(self, response):
        ...
        text_nodes = response.css('div.article__content p ::text').getall()
