...
class GrimsbytelegraphSpider(SitemapSpider):
    name = 'grimsbytelegraph'
    allowed_domains = ['grimsbytelegraph.co.uk']
    sitemap_urls = ['https://www.grimsbytelegraph.co.uk/map_news.xml']
    custom_settings = {
