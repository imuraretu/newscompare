...
class StiripesurseSpider(SitemapSpider):
    name = 'stiripesurse'
    allowed_domains = ['stiripesurse.ro']
    sitemap_urls = ['https://www.stiripesurse.ro/sitemap-google-news/sitemap_google_news.xml']
    ...
    def parse(self, response):
        ...
        text_nodes = response.css('article.article-single p::text').getall()
