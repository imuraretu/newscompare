...
class MediafaxSpider(SitemapSpider):
    name = 'mediafax'
    allowed_domains = ['mediafax.ro']
    sitemap_urls = ['https://www.mediafax.ro/sitemap.xml']
    ...
    def parse(self, response):
        ...
        text_nodes = response.css('div.just-article-content p::text').getall()
