...
class NorthernIrelandWorldSpider(SitemapSpider):
    name = 'northernirelandworld'
    allowed_domains = ['northernirelandworld.com']
    sitemap_urls = ['https://www.northernirelandworld.com/sitemaps/googlenews']
    custom_settings = {
