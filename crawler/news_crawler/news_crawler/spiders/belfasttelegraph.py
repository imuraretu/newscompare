...
class BelfastTelegraphSpider(SitemapSpider):
    name = 'belfasttelegraph'
    allowed_domains = ['belfasttelegraph.co.uk']
    sitemap_urls = ['https://www.belfasttelegraph.co.uk/sitemap/sitemap_googlenews.xml']
    custom_settings = {
    ...
    def parse(self, response):
        ...
        item['date'] = parse(response.css('meta[property="article:modified_time"]::attr(content)').get()).isoformat()
